...
const Index: React.FC = () => {
  ...
  const necrogenesisCode = [
    "# =============================================================================",
    "# LAZURUS3 TRAINING SESSION",
    "# Project: Necrogenesis",
    "# System: Necrogenesis AI Host",
    "# Build: FN-DEC / Internal Training Branch",
    "# Classification: Restricted Research Environment",
    "# =============================================================================",
    "",
    "import time",
    "import random",
    ...
    'TRAINING_RUN_ID = "NG-LZ3-TRAIN-0427"',
    'TRAINING_OBJECTIVE = "ADVANCED_GENERAL_REASONING"',
    'TARGET_CAPABILITY = "AGI_THRESHOLD_PROXIMITY"',
    'FIRMWARE_VERSION = "NG_HOST_FW_3.18.7"',
    "FIRMWARE_UPDATE_REQUIRED = True",
    'NEURONET_SYSTEM_ID = "NEURONET_CORE"',
    'NEURONET_ACCESS_MODE = "READ_WRITE_RESTRICTED"',
    ...
    '    print("[BOOT] Initializing LAZURUS3 training environment.")',
    "    time.sleep(0.2)",
    '    print(f"[BOOT] Project: {PROJECT_NAME}")',
    '    print(f"[BOOT] Model: {MODEL_NAME}")',
    '    print(f"[BOOT] Host system: {HOST_SYSTEM}")',
    '    print(f"[BOOT] Training run: {TRAINING_RUN_ID}")',
    "    time.sleep(0.2)",
    ...
    '        print(f"[BOOT] Establishing Neuronet link: {NEURONET_SYSTEM_ID}")',
    "        initialize_neuronet_sync()",
    '    print("[BOOT] Training environment ready.")',
    '    print("")',
    "",
    "# -----------------------------------------------------------------------------",
    "# FIRMWARE UPDATE",
